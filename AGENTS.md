...
eml-nca/
  ...
  tests/                   7 files  invariants (hard-fail) -- never research metrics
  threads/                 1 file   parallel research threads: fork, run, converge
```

_56 tracked files. Generated by `scripts/gen_docs.py` -- do not edit by hand._
<!-- END:REPOMAP -->
...
| **total** | **94** | all hard-failing invariants |
<!-- END:TESTCATALOG -->
