...
eml-nca/
  ...
  tests/                   9 files  invariants (hard-fail) -- never research metrics
...
_62 tracked files. Generated by `scripts/gen_docs.py` -- do not edit by hand._
<!-- END:REPOMAP -->
...
| **total** | **114** | all hard-failing invariants |
<!-- END:TESTCATALOG -->
